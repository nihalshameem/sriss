...
class DistrictController extends Controller
{
    ...
    $districtId = District::where('zoneid',$request->search)->pluck('id')->toArray();
        $districtCount = count($districtId);
            ...
            if($districts){
                foreach ($districts as $key => $district) {
                    ...
                    $output.='<tr>'.
                                ...
                                '<td><a href="/district_delete/'.$district["id"].'" onclick="return checkDelete()" ><i class="fa fa-trash fa-lg" style="text-align:cenetr;" ></i></a></td>'.
                                
                                
                                '<td><a href="/district_volunteer/'.$district["id"].'" >';
                                ...
                                $output.='<td><a href="/district_volunteer_details/'.$district["id"].'" ><i class="fa fa-user fa-lg" style="text-align:cenetr;">'.$district["volCount"].'</i></a></td>'.
