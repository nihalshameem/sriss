...
class HomeControllers extends Controller
{
 ...
 public function __construct()
    ...
    $today_members = DB::table('members')->where('active_flag','yes')->whereDay('created_at', $toDay)->whereYear('created_at', $thisYear)->get();
    $today_notifications = DB::table('notifications')->whereDay('created_at', $toDay)->whereYear('created_at', $thisYear)->get();
    $today_ads = DB::table('advertisements')->whereDay('created_at', $toDay)->whereYear('created_at', $thisYear)->get();
    $today_polls = DB::table('pollquestions')->whereDay('created_at', $toDay)->whereYear('created_at', $thisYear)->get();
    
    
    $yesterday_members = DB::table('members')->where('active_flag','yes')->whereDay('created_at', $lastDay)->whereYear('created_at', $thisYear)->get();
    $yesterday_notifications = DB::table('notifications')->whereDay('created_at', $lastDay)->whereYear('created_at', $thisYear)->get();
    $yesterday_ads = DB::table('advertisements')->whereDay('created_at', $lastDay)->whereYear('created_at', $thisYear)->get();
    $yesterday_polls = DB::table('pollquestions')->whereDay('created_at', $lastDay)->whereYear('created_at', $thisYear)->get();
