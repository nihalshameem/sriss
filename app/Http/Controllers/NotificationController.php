...
class NotificationController extends Controller
{
            ...
            if($notifications){
                foreach ($notifications as $key => $notification) {
                    $output.='<tr>'.
                                ...
                                '<td><a href="/notification_delete/'.$notification->id.'" ><i class="fa fa-trash fa-lg" style="text-align:cenetr;"></i></a></td>'.
                                '</tr>';
                }
            }
    ...
    if ($validator-> fails()){
        ...
        if($request->image){
        $notification->image = 'sriss.in/storage/app/public/upload/notifications/'.$filename;
        }
    ...
    if($request->image){
        ...
        $notifications = Notification::find($request->id);
           ...
           if(isset($request->image))
            {
            $notifications->image ='sriss.in/storage/app/public/upload/notifications/'.$filename;
            }
