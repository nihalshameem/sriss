...
class TalukController extends Controller
{
    ...
    //$taluks['taluks']=Taluk::where('distid',$firstdistrictid)->orderBy('taluk')->get();
            ...
            if($taluks){
                foreach ($taluks as $key => $taluk) {
                    $output.='<tr>'.
                                ...
                                '<td><a href="/taluk_delete/'.$taluk["id"].'" onclick="return checkDelete()"><i class="fa fa-trash fa-lg" style="text-align:cenetr;"></i></a></td>'.
                                
                                
                                 '<td><a href="/taluk_volunteer/'.$taluk["id"].'" >';
                                ...
                                $output.='<td><a href="/taluk_volunteer_details/'.$taluk["id"].'" ><i class="fa fa-user fa-lg" style="text-align:cenetr;">'.$taluk["volCount"].'</i></a></td>'.
    ...
    return view('volunteer_edit',$volunteers);
    }
