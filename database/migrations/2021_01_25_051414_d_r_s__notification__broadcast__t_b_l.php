...
class DRSNotificationBroadcastTBL extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         Schema::create('DRS_Notification_Broadcast_Tbl', function (Blueprint $table) {
            $table->increments('Notification_Broadcast_id');

            $table->unsignedInteger('Notification_id')->nullable();
            $table->foreign('Notification_id')
                ->references('Notification_id')
                ->on('drs_notification_tbl');
