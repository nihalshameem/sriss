  ...
  <section class="content" style="padding-top:25px">
    <div class="container-fluid">
        <div class="col-12">
            ...
            <div class="row mb-2">
              <div class="col-sm-2">
                <a href="/party/list" class="btn btn-back" style="float:left;border-radius: 3px;background-color: aqua;margin-top: -10px;margin-left: -16px;"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;</a>
            </div>
            <div class="col-sm-3">
            </div>
            <div class="col-sm-5">
...
<input type="hidden" name="id" value="{{$PartyLeader->Party_Id}}">
  ...
  <div style="max-width: 200px; margin: auto;">
      <a href="/party/list" class="btn btn-primary">Cancel</a>
