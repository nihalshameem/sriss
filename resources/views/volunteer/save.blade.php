                         ...
                         <table id="example1" class="table table-borderless">
                           ...
                           <tbody>
                            ...
                            <?php
                                 ...
                                 $statdivision =\App\Models\StateDivision::where('State_Division_id',$volunteer->State_Division_Id)->first();
                                 $GreaterZones =\App\Models\GreaterZones::where('Greater_Zones_Id',$volunteer->Greater_Zones_Id)->first();
                                  ...
                                  $Panchayat =\App\Models\Panchayat::where('Panchayat_id',$volunteer->Panchayat_Id)->first();
                                  $Village =\App\Models\Village::where('Village_id',$volunteer->Village_Id)->first();
                                $Street =\App\Models\Street::where('Street_id',$volunteer->Street_Id)->first();
                            ?>
                              <tr>
                                  @if($state!=null)
                            ...
                            @else
                                <td></td>
                            @endif
                                @if($statdivision!=null)
                                <td>{{ $statdivision->State_Division_desc }}</td>
                                @else
                                <td></td>
                                @endif
        ...
        <div class="row">
            <div class="col-md-4 form-group">
                      <label for="exampleInputPassword1">State</label><br>
                        <select class="form-control" id="states" name="State_id" onchange="LoadStateDivision(this)">
                 ...
                 <div class="col-md-4 form-group">
                      <label for="exampleInputPassword1">State Division</label>
                       <select class="form-control" id="StateDivision"name="State_Division_id" onchange="LoadGreaterZones(this)">
                ...
                <div class="col-md-4 form-group">
                      <label for="exampleInputPassword1">Greater Zones</label>
                       <select class="form-control" id="GreaterZones" name="Greater_Zones_id" onchange="LoadZones(this)">
                ...
                <div class="col-md-4 form-group">
                      <label for="exampleInputPassword1">Panchayat</label><br>
                       <select class="form-control" id="Panchayat"  name="Panchayat_id" onchange="LoadVillage(this)">
                 ...
                 <div class="col-md-4 form-group">
                      <label for="exampleInputPassword1">Village</label><br>
                       <select class="form-control" id="Village"  name="Village_id" onchange="LoadStreet(this)">
                 ...
                 <div class="col-md-4 form-group">
                      <label for="exampleInputPassword1">Street</label><br>
                       <select class="form-control" id="Street"  name="Street_id" >
