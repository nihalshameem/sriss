 ...
 <div class="content-wrapper">
  ...
  <section class="content" style="padding-top:30px">
    <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-2">
            <a href="/User" class="btn btn-back" style="float:left;border-radius: 3px;background-color: aqua;margin-top: -15px;margin-left: -16px;"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;</a>
          </div>
          <div class="col-sm-3">
          </div>
          <div class="col-sm-5">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form role="form" method="post" class="col-md-6" action="{{ url('Permission/Update') }}" enctype="multipart/form-data" style="margin:0 auto;">
              @csrf
        ...
        @endif
         <input type="hidden" class="form-control" name="Id" placeholder="Enter Name" value="{{ $Permission->id }}" required>
                 <div class="form-group">
                      <label for="exampleInputPassword1">Name</label>

                      <input type="text" class="form-control" name="name" placeholder="Enter Name" value="{{ $Permission->name }}" required>
