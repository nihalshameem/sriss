  ...
  <section class="content" style="padding-top:25px">
    ...
    <div class="col-12">
      <div class="row mb-2">
        ...
        <div class="col-sm-1">
          <a onclick="exportTableToExcel('volunteersearch','volunteer_reports')" style="float:right;cursor: pointer"  style="float:right"><i class="fa fa-download" aria-hidden="true" style="font-size:30px;color:#8f3319"></i></a>
        </div>
...
<script>
  function VolunteerFilter()
  {
    ...
    $.ajax({
      type : 'get',
      url : '{{URL::to('Reports/volunteer/filter')}}',
