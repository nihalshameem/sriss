...
<table width="100%" cellpadding="10px" class="col-md-offset-2 col-md-10">
    <tr style="border-bottom:none"><th colspan="8" style="text-align: center;padding:10px;font-size:20px">This Month Advertisements <span class="label label-success">{{ count($thismonth_ads) }}</span></th></tr>
    <tr style="padding:50px;height:50px">        
        ...
        <a href="/fob/thismonth_ads_xlsx" style="color:purple;margin-left: 20px;padding:10px;font-size:25px"><i class="fa fa-download" aria-hidden="true"></i></a></td>
        </center>
    </tr>
...
@foreach($thismonth_ads as $thismonth_ad)
    <tr style="height:20px;border:1px solid grey">
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $i++ }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thismonth_ad['created_at'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thismonth_ad['description'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thismonth_ad['company'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thismonth_ad['link'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thismonth_ad['from_date'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thismonth_ad['to_date'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thismonth_ad['active'] }}</td>
    </tr>
@endforeach
</table>
