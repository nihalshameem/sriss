...
<table width="100%" cellpadding="10px" class="col-md-offset-2 col-md-10">
    <tr style="border-bottom:none"><th colspan="8" style="text-align: center;padding:10px;font-size:20px">This year Advertisements<span class="label label-success">{{ count($thisyear_ads) }}</span></th></tr>
...
@foreach($thisyear_ads as $thisyear_ad)
     <tr style="height:20px;border:1px solid grey">
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $i++ }}</td>
       <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thisyear_ad['created_at'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thisyear_ad['description'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thisyear_ad['company'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thisyear_ad['link'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thisyear_ad['from_date'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thisyear_ad['to_date'] }}</td>
        <td style="padding:10px;text-align:center;border:1px solid grey">{{ $thisyear_ad['active'] }}</td>
    </tr>
@endforeach
