   ...
   <div class="container-fluid">
    <div class="col-12">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-4">
          <h3 class="title-head">Subscription Report View & Download</h3>
        </div>
        <div class="col-sm-2">
        </div>
    ...
    <div class="col-12">
      <div class="row mb-2">
       ...
       <div class="col-sm-1" style="padding-top:30px">
        <a onclick="exportTableToExcel('onlinereport','subscription reports')" style="float:right;cursor: pointer"><i class="fa fa-download" aria-hidden="true" style="font-size:30px;color:#8f3319"></i></a>
      </div>
    </div>
  </div>
  <div class="col-12">
     ...
     <div class="col-12">
       <div class="card">
         ...
         <div class="card-body" id="onlinereport">
          ...
          @include('reportsview.reportsfilter.subscription_filter')
        </div>
        <!-- /.card-body -->
      </div>
      <!-- /.card -->
...
<script>
  function CollectionFilter()
  {
    ...
    $.ajax({
      type : 'get',
      url : '{{URL::to('ReportsView/Subscription/Filter')}}',
