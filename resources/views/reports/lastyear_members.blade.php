...
<table width="100%" cellpadding="10px" class="col-md-offset-2">
    ...
    <tr style="padding:50px;height:50px">        
        ...
        <a href="/lastyear_members_xlsx" style="color:purple;margin-left: 20px;padding:10px;font-size:25px"><i class="fa fa-download" aria-hidden="true"></i></a></td>
        </center>
    </tr>
...
@foreach($lastyear_members as $lastyear_member)
    <tr style="height:20px;border:1px solid grey">
        ...
        <td style="padding:10px;border:1px solid grey">{{ $lastyear_member['created_at'] }}</td>
        <td style="padding:10px;border:1px solid grey">{{ $lastyear_member['member_id'] }}</td>
        <td style="padding:10px;border:1px solid grey">{{ $lastyear_member['name'] }}</td>
        <td style="padding:10px;border:1px solid grey">{{ $lastyear_member['mobile_number'] }}</td>
