...
<div class="col-12">
    <div class="row mb-2">
      ...
      <div class="col-sm-3" style="padding-top:9px;float:right">
          <a onclick="exportTableToExcel('member_report','member_reports')" style="float:right;cursor: pointer"><i class="fa fa-download" aria-hidden="true" style="font-size:30px;color:#8f3319"></i></a>
      </div>
...
<script>
  function MemberFilter()
  {
    ...
    $.ajax({
        type : 'get',
        url : '{{URL::to('Reports/MemberList/Filter')}}',
