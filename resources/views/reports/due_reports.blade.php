		...
		<div class="container-fluid">
			...
			<div class="col-12">
				<div class="row mb-2">
					...
					<div class="col-sm-3">
						<a onclick="exportTableToExcel('duereport','duereport')" style="float:right;cursor: pointer"><i class="fa fa-download" aria-hidden="true" style="font-size:30px;color:#8f3319"></i></a>
					</div>
				</div>
			</div>
			<div class="col-12">
