    ...
    <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
              ...
              <form role="form" method="post" class="col-md-6 "  action="{{ route('Update.BoothAgent') }}"  style="margin: 0 auto;padding-top: 10px;padding-bottom:20px">
                @csrf
...
<input type="hidden" class="form-control" name="id" placeholder="Enter Description" value="{{$BoothAgent->Booth_Agent_Id}}" required>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="Booth_Agent_Desc" placeholder="Enter Description" value="{{$BoothAgent->Booth_Agent_Desc}}" required>
                
            </div>
             <div class="form-group">
                <label for="exampleInputPassword1">Booth Agent Name</label>
                <input type="text" class="form-control" name="Booth_Agent_Name" placeholder="Enter Booth Agent Name" value="{{$BoothAgent->Booth_Agent_Name}}" required>
