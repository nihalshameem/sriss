        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="/vision_update" method="POST">
                             {{ csrf_field() }}
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="tamil" placeholder="" rows="10"  cols="100" name="tamil" value="{{ $vision['text_tamil']}}"  required>{{ $vision['text_tamil']}}</textarea>
                          </div>
                        </div>
