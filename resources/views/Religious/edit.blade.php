  ...
  <section class="content" style="padding-top:25px">
    <div class="container-fluid">
        <div class="col-12">
            ...
            <div class="col-sm-5">
                <h3 class="title-head">Edit Religious</h3>
            </div>
            <div class="col-sm-3">
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
              ...
              <form role="form" method="post" class="col-md-6 "  action="{{ route('Update.Religious') }}"  style="margin: 0 auto;padding-top: 10px;padding-bottom:20px">
                @csrf
