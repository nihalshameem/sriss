        ...
        <section class="content" style="padding-top:25px">
          <div class="container-fluid">
           <div class="col-12">
            ...
            <div class="row mb-2">
              <div class="col-sm-2">
                <a href="{{ route('edit.notification', ['Notification' => $notifications->Notification_id]) }}" class="btn btn-back" style="float:left;border-radius: 3px;margin-top: -15px;margin-left: -19px;"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;</a>
            </div>
            <div class="col-sm-2">
            </div>
            <div class="col-sm-4">
                <h3 class="title-head">Notification Group Broadcast Edit</h3>
            </div>
            <div class="col-sm-3">
            </div>
    ...
    <form role="form" method="post" onSubmit="return confirm('Please note that all the previous broadcast options will be removed and you have to re-enter broadcast details again');" action="{{ route('update.NotificationGroupBroadcast') }}" enctype="multipart/form-data" >
      ...
      <div class="row">
        ...
        <div class="col-md-6 form-group">
          <label for="exampleInputPassword1" style="text-align:center">Notification Message</label><br>

          <textarea class="form-control" name="message" placeholder="Enter Message" value="{{$notifications->Notification_mesage }}" disabled=""> {{ $notifications->Notification_mesage}}</textarea>
      </div>
       <div class="col-md-3 form-group">
