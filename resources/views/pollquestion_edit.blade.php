        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="/pollquestion_update" method="POST" enctype="multipart/form-data">
                             {{ csrf_field() }}
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="des" placeholder="" name="question"  maxlength="1000" required>{{ $pollquestions['question']}}</textarea>
                          </div>
                        </div>
