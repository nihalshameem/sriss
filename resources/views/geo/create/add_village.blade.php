    ...
    <div class="col-12">
      <div class="col-12">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-5">
            <h3 class="title-head">Add Village</h3>
          </div>
          <div class="col-sm-3">
       ...
       <div class="col-12">
         <div class="card">
           ...
           <div class="card-body" >
            ...
            <form role="form" method="post" id="villageForm" class="col-md-6 was-validated"  action="{{ route('AddVillage') }}" enctype="multipart/form-data" style="margin: 0 auto;padding-top: 10px;padding-bottom:20px">
              @csrf
              <div class="form-group">
                ...
                <select class="form-control" name="PanchayatId" required>
                  ...
                  <option value="{{$panchayat->Panchayat_id}}"  >{{ $panchayat->Panchayat_desc}}</option>
                  @endforeach
                  @endif
                </select>
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Number Of Village</label>
...
<script>
  function responses(textbox){
    ...
    if(value!="")
    {
      ...
      {
        j=i+1;
        $('<div id="row'+value+'">'+'<div class="form-group">'+'<label class="form-lable">Village Name</label>'+
