                ...
                <div class="row">
                      ...
                      @foreach($AppIcon as $AppIconschecked) 
                         <div class="col-md-4 form-group">
                                <input type="checkbox" name="AppIcon[]"  value="{{ $AppIconschecked->AppIcon_id}}" id="permission" checked>&nbsp;&nbsp;{{ $AppIconschecked->AppIcon_desc}}<br>
                        </div>
                      ...
                      ?>
                       ...
                       <div class="col-md-4 form-group">
                      <input type="checkbox" name="AppIcon[]"  value="{{ $AppIconsUnchecked->AppIcon_id}}" id="permission" >&nbsp;&nbsp;{{ $AppIconsUnchecked->AppIcon_desc}}<br>
                      </div> 
                      <input type="hidden" class="form-control"  name="categoryId[]" value="{{$membercategory->MemberCategory_id}}"> 
                      @endforeach
                    </div>
