    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add {{ $taluk['taluk']}} Volunteer</div>

                <div class="panel-body">
                    <form class="form-horizontal" action="{{ url('taluk_volunteer') }}" method="POST">
                             {{ csrf_field() }}
                        

  
                        <input type="hidden" class="form-control" name="type" value="a" >
                        <input type="hidden" class="form-control" name="type_id" value="{{ $taluk['id']}}" >
      ...
      <div id="membername" class="col-sm-5">
          <input type="text" class="form-control" name="membername" value="" readonly>
					...
					<div class="form-group">
                       	...
                       	<div class="col-sm-5">
                        <input type="date" class="form-control" max="9999-12-31" id="fdate" placeholder="Select From Date" name="fdate" required>
                       	</div>
                    </div>
                    ...
                    <div class="form-group">
                      	...
                      	<div class="col-sm-5">          
                        <input type="date" class="form-control" max="9999-12-31" id="tdate" placeholder="Enter To Date " name="tdate" required>
                      	</div>
                    </div>
