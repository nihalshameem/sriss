...
//yesterday
    ...
    $lastDay = date('d')-1;
    $thisMonth = date('m');
	    $yesterday_members = Member::where('active_flag','yes')->whereDay('created_at', $lastDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
    ...
    $lastDay = date('d')-1;
    $thisMonth = date('m');
	    $yesterday_notifications = Notification::whereDay('created_at', $lastDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
    ...
    $lastDay = date('d')-1;
    $thisMonth = date('m');
	    $yesterday_ads = Advertisement::whereDay('created_at', $lastDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
    ...
    $lastDay = date('d')-1;
    $thisMonth = date('m');
	    $yesterday_polls = Pollquestion::whereDay('created_at', $lastDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
...
//today
    ...
    $thisMonth = date('m');
		...
		$today_members = Member::where('active_flag','yes')->whereDay('created_at', $toDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
    ...
    $thisYear = date('Y');
    $thisMonth = date('m');
		$today_notifications = Notification::whereDay('created_at', $toDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
    ...
    $thisYear = date('Y');
    $thisMonth = date('m');
		$today_ads = Advertisement::whereDay('created_at', $toDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
    ...
    $thisYear = date('Y');
    $thisMonth = date('m');
		$today_polls = Pollquestion::whereDay('created_at', $toDay)->whereMonth('created_at', $thisMonth)->whereYear('created_at', $thisYear)->get();
