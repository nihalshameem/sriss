...
@foreach($lastmonth_ads as $lastmonth_ad)
    <tr style="height:20px">
        <td>{{ $lastmonth_ad['id'] }}</td>
        <td>{{ $lastmonth_ad['description'] }}</td>
        <td>{{ $lastmonth_ad['company'] }}</td>
        <td>{{ $lastmonth_ad['link'] }}</td>
        <td>{{ $lastmonth_ad['from_date'] }}</td>
        <td>{{ $lastmonth_ad['to_date'] }}</td>
        <td>{{ $lastmonth_ad['active'] }}</td>
    </tr>
@endforeach
</table>
