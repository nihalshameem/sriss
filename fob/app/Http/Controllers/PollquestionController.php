            ...
            if($polls){
                foreach ($polls as $key => $poll) {
                    $output.='<tr>'.
                                ...
                                '<td><a href="/fob/poll_receipt_edit/'.$poll->id.'" ><i class="fa fa-edit fa-lg" style="text-align:cenetr;"></i></a></td>'.
                                
                                '<td><a href="/fob/poll_delete/'.$poll->id.'"  onclick="return checkDelete()"><i class="fa fa-trash fa-lg" style="text-align:cenetr;"></i></a></td>'.
