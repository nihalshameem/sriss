...
class AdvertisementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator-> fails()){
            return back()->with('image-error', 'image error!! ');
        }
        ...
        if($request->img){
        $advertisement->image_path = 'sriss.in/fob/storage/app/public/upload/advertisements/'.$filename;
        }
        
        if($request->bannerimg){
        $advertisement->banner_image = 'sriss.in/fob/storage/app/public/upload/advertisements/banner/'.$bannerfilename;
        }
    ...
    public function edit($id)
    {
        ...
        return view('advertisement_edit',$advertisement);
    }
    ...
    if($request->bannerimg){
        ...
        $advertisements = Advertisement::find($request->id);
            ...
            {
            $advertisements->image_path ='sriss.in/fob/storage/app/public/upload/advertisements/'.$filename;
            }
            
            if(isset($request->bannerimg))
            {
            $advertisements->banner_image ='sriss.in/fob/storage/app/public/upload/advertisements/'.$bannerfilename;
            }
