    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align:center;background-color:#F3F8FA;"><a href="{{ redirect()->getUrlGenerator()->previous() }}"><i class="fa fa-arrow-left fa-lg" style="float:left"></i></a>{{ $taluk['taluk']}} &nbsp Volunteers</div>
