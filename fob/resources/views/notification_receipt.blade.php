...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-2">
          ...
          <form class="form-horizontal" action="{{ url('add_nreceipt') }}" method="POST">
                             {{ csrf_field() }}
            ...
            <div class="col-md-6 form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="note" name="notifications" value="{{ $lastid[0]->id }}" placeholder="{{ $lastid[0]->description }}" readonly>
                </div>
            ...
            <div class="col-md-6 form-group">
                ...
                <textarea class="form-control" id="notification" placeholder=""  value="{{ $lastid[0]->description }}"    readonly>{{ $lastid[0]->description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group">        
                          <div class="col-sm-offset-3 col-sm-5">
                            ...
                            <a class="btn btn-default btn-close" href="/fob/notificationonly_delete/{{ $lastid[0]->id }}">Cancel</a>
                          </div>
            </div>
