        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="/fob/add_poll_response" method="POST">
                             {{ csrf_field() }} 

                        
                        <div class="form-group">
                            <label class="control-label col-sm-3" for="quet"> Question Id:</label> 

                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="note" name="questionid" value="{{ $lastid->id }}" placeholder="{{ $lastid->question }}" readonly>
                        </div>
              </div>
                        ...
                        <div class="form-group">        
                          ...
                          <a class="btn btn-default btn-close" href="/fob/pollquestiononly_delete/{{ $lastid->id }}">Back</a>
