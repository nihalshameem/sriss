    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-2">
            <div class="panel panel-default">
              <div class="panel-heading">Update Poll Receipts</div>

          <div class="panel-body">
              
          <form class="form-horizontal" action="/fob/poll_receipt_update"  method="POST">
                             {{ csrf_field() }}

            <div class="form-group col-md-6">
                <label class="control-label col-sm-6" for="questionid">Question Id:</label> 
                
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="questionid" name="questionid" value="{{ $poll['id']}}" placeholder="{{ $poll['id']}}" readonly>
                </div>
            ...
            <div class="form-group col-md-6">
                <label class="control-label col-sm-6" for="question">Question:</label> 
                <div class="col-sm-6">
              
                <textarea class="form-control" id="question" placeholder=""  value="{{ $poll['question']}}"    readonly>{{ $poll['question']}}</textarea>
                </div>
            </div>
