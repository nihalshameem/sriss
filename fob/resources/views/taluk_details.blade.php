    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align:center;background-color:#F3F8FA;">Area Details<a href="{{ url( 'add_taluk' ) }}"><i class="fa fa-plus-square fa-lg" style="float:right"></i></a>
                  ...
                  <tbody>  
                    @foreach($taluks as $taluk)
                      <tr>
                        ...
                        <td><a href="/fob/taluk_delete/{{ $taluk['id'] }}" onclick="return confirm('Are you sure,You want to delete?')"><i class="fa fa-trash fa-lg" style="text-align:cenetr;"></i></a></td>
                        
                        @if($taluk['active_vol']=="yes")
                        <td><a href="/fob/taluk_volunteer/{{ $taluk['id'] }}" ><i class="fa fa-check fa-lg" style="text-align:cenetr;"></i></a></td>
                        @else
                        <td><a href="/fob/taluk_volunteer/{{ $taluk['id'] }}" ><i class="fa fa-remove fa-lg" style="text-align:cenetr;color:red;"></i></a></td>
                        @endif
                        
                        <td><a href="/fob/taluk_volunteer_details/{{ $taluk['id'] }}" ><i class="fa fa-user fa-lg" style="text-align:cenetr;"></i>{{ $taluk['volCount'] }}</a></td>
                    @endforeach
                  </tbody> 
                </table>
