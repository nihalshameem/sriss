    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-2">
            <div class="panel panel-default">
              <div class="panel-heading">Update Advertisement Receipts</div>

          <div class="panel-body">
              
          <form class="form-horizontal" action="/fob/advertisement_receipt_update"  method="POST">
                             {{ csrf_field() }}

            <div class="col-md-6 form-group">
                <label class="control-label col-sm-6" for="advertisement">Advertisement Id:</label> 
                
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="advertisement" name="advertisements" value="{{ $advertisement['id']}}" placeholder="{{ $advertisement['id']}}" readonly>
                </div>
            ...
            <div class="col-md-6 form-group">
                <label class="control-label col-sm-6" for="add">Advertisement:</label> 
                <div class="col-sm-6">
              
                <textarea class="form-control" id="add" placeholder=""  value="{{ $advertisement['description']}}"    readonly>{{ $advertisement['description']}}</textarea>
                </div>
            </div>
